...
type EditProductFormInputs = Omit<Product, 'id' | 'rating' | 'imageUrl'>;
...
const EditProduct: React.FC = () => {
    ...
    const productToEdit = useSelector((state: RootState) => state.products.allProducts.find(p => p.id === id));
    ...
    if (!productToEdit) {
        return <div className="text-center p-8">Product not found. <button onClick={() => navigate('/products')} className="text-blue-500">Go back</button></div>;
    }
